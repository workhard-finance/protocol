...
interface VisionTokenEmitterInterface extends ethers.utils.Interface {
  functions: {
...
export class VisionTokenEmitter extends Contract {
  ...
  interface: VisionTokenEmitterInterface;
