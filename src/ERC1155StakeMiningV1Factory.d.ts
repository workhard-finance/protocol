...
interface ERC1155StakeMiningV1FactoryInterface extends ethers.utils.Interface {
  functions: {
...
export class ERC1155StakeMiningV1Factory extends Contract {
  ...
  interface: ERC1155StakeMiningV1FactoryInterface;
