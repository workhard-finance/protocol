...
interface ProductInterface extends ethers.utils.Interface {
  functions: {
    ...
    "setManufacturer(address)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "setManufacturer",
    values: [string]
  ): string;
  encodeFunctionData(
  ...
  events: {
    ...
    "ManufacturerUpdated(address)": EventFragment;
  ...
  getEvent(nameOrSignatureOrTopic: "ManufacturerUpdated"): EventFragment;
...
export class Product extends Contract {
  ...
  filters: {
    ...
    ): TypedEventFilter<[string], { _manufacturer: string }>;
