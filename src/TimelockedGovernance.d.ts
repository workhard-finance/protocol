...
interface TimelockedGovernanceInterface extends ethers.utils.Interface {
  functions: {
    ...
    "nonCancelable(bytes32)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "nonCancelable",
    values: [BytesLike]
  ): string;
  encodeFunctionData(
...
export class TimelockedGovernance extends Contract {
  ...
  interface: TimelockedGovernanceInterface;
  ...
  nonCancelable(arg0: BytesLike, overrides?: CallOverrides): Promise<boolean>;
