...
interface ERC721StakeMiningV1FactoryInterface extends ethers.utils.Interface {
  functions: {
...
export class ERC721StakeMiningV1Factory extends Contract {
  ...
  interface: ERC721StakeMiningV1FactoryInterface;
