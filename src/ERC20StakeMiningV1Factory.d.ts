...
interface ERC20StakeMiningV1FactoryInterface extends ethers.utils.Interface {
  functions: {
...
export class ERC20StakeMiningV1Factory extends Contract {
  ...
  interface: ERC20StakeMiningV1FactoryInterface;
