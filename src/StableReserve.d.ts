...
interface StableReserveInterface extends ethers.utils.Interface {
  functions: {
    ...
    "priceOfCOMMIT()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "priceOfCOMMIT",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export class StableReserve extends Contract {
  ...
  interface: StableReserveInterface;
  ...
  functions: {
    ...
    priceOfCOMMIT(overrides?: CallOverrides): Promise<[BigNumber]>;
  ...
  populateTransaction: {
    ...
    priceOfCOMMIT(overrides?: CallOverrides): Promise<PopulatedTransaction>;
