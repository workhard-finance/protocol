...
interface ERC721StakeMiningInterface extends ethers.utils.Interface {
  functions: {
...
export class ERC721StakeMining extends Contract {
  ...
  interface: ERC721StakeMiningInterface;
