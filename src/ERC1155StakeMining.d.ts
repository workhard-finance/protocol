...
interface ERC1155StakeMiningInterface extends ethers.utils.Interface {
  functions: {
...
export class ERC1155StakeMining extends Contract {
  ...
  interface: ERC1155StakeMiningInterface;
