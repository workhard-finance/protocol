...
interface ERC721StakeMiningV1Interface extends ethers.utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "dispatchableMiners",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "erc721StakeMiningV1",
    values?: undefined
  ): string;
...
export class ERC721StakeMiningV1 extends Contract {
  ...
  interface: ERC721StakeMiningV1Interface;
  ...
  functions: {
    ...
    dispatchableMiners(
      tokenId: BigNumberish,
      overrides?: CallOverrides
    ): Promise<[BigNumber] & { numOfMiner: BigNumber }>;

    "dispatchableMiners(uint256)"(
      tokenId: BigNumberish,
      overrides?: CallOverrides
    ): Promise<[BigNumber] & { numOfMiner: BigNumber }>;
    ...
    erc721StakeMiningV1(overrides?: CallOverrides): Promise<[boolean]>;
  ...
  callStatic: {
    ...
    _stake(tokenId: BigNumberish, overrides?: CallOverrides): Promise<void>;
    ...
    stake(id: BigNumberish, overrides?: CallOverrides): Promise<void>;
  ...
  estimateGas: {
    ...
    erc721StakeMiningV1(overrides?: CallOverrides): Promise<BigNumber>;
