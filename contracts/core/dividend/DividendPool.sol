...
contract DividendPool is Governed, HasInitializer {
    ...
    /**
     * @notice Stakers can stake VISIONs to lock them.
     * @param amount The amount of VISIONs to stake. Once there exists staking from this account,
    ...
    /**
     * @notice Stakers can lock the staked VISIONs and dispatch farmers to the farms.
     ...
     * @param amount The amount of VISIONs to unstake and withdraw.
     */
    ...
    /**
     * @notice Users can stake VISIONs and lock them in one transaction.
     * @param amount The amount of VISIONs to stake.
